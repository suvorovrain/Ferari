...
mod tests {
    ...
    fn test_load_game_map() {
        ...
        assert_eq!(mob_2_behaviour.speed, Some(8.0));
        assert_eq!(mob_2.start_position(), (15, 15));
